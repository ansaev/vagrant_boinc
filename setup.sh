...
touch m.db.sc && exec 6>&1 && exec > m.db.sc && echo "GRANT ALL ON *.* TO 'vagrant'@'localhost';" && echo "SET PASSWORD FOR 'vagrant'@'localhost'='';" && exec 1>&6 6>&-
mysql -h localhost -u root --password=pass666666 < m.db.sc
